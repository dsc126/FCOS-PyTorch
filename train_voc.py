...
train_dataset = VOCDataset(root_dir='data/VOCdevkit/VOC0712',resize_size=[800,1333],
...
for epoch in range(EPOCHS):
    for epoch_step, data in enumerate(train_loader):
        ...
        if opt.use_tfboard:
            ...
            'loss_cnt': losses[1].mean(),
            'loss_reg': losses[2].mean(),
            }
            logger.add_scalars("logs_train/losses", info, GLOBAL_STEPS)
